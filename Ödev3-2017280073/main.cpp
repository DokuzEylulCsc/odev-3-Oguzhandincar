...
int main()
{
    ...
    //input.txt dosyasýndan verileri çekiyorum
    ...
    while(dosya){  //input.txt'de 1.sutun=ogrenciID,2.sutun=ogrenciCevap olarak atadým.
    ...
    //dogru,yanlis ve bos cevaplarin soylendigi gibi puanlarýný atadým ve tuttum.
